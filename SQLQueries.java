public class SQLQueries		
{
  ...
  public static final String CREATE_TRANSACTION_TABLE =
	"CREATE TABLE IF NOT EXISTS Transaction(Transaction_Id int primary key auto_increment,Sender_Account_No bigint ,foreign key(Sender_Account_No) references Account(account_No) ,Receiver_Account_No bigint, foreign key(Receiver_Account_No) references Account(account_No) ,Amount double not null, DateAndTiming TIMESTAMP)";
